<header id="menu-header" class="lg:fixed lg:h-full lg:z-20 lg:px-4 lg:transition-all lg:duration-300 lg:ease-in-out flex flex-col items-center gap-10 py-5 px-4 text-white bg-red-900 lg:overflow-hidden lg:w-[3.9rem]" onmouseover="expandMenu()" onmouseleave="collapseMenu()">
    ...
    <nav id="menu" class="text-center lg:text-left hidden h-full lg:h-auto lg:block absolute top-24 left-0 w-full backdrop-blur lg:backdrop-blur-none bg-red-900 lg:bg-transparent lg:static lg:w-full z-10">
