...
<div class="flex justify-center items-center h-screen ">
        <div class="flex">
            <div class="bg-gray-300 p-6 lg:rounded-tl lg:rounded-bl shadow-md lg:w-[40rem] lg:h-[50rem] w-[23rem] h-[35rem] justify-center flex flex-col items-center">
                ...
                <form method="POST" action="">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="password" name="password" id="password" class="w-full border border-gray-900 p-2 rounded-md bg-transparent">
                    </div>
            ...
            <div class="bg-red-500 p-6 rounded shadow-md  w-[40rem] h-[50rem] lg:block hidden">
