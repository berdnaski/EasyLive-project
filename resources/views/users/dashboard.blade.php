        ...
        <div id="modal" class="fixed z-10 inset-0 overflow-y-auto hidden">
            <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                ...
                <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                    <div class="bg-red-300 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        <div class="flex flex-row items-center justify-between">
                            <div class="sm:flex sm:items-start mb-5">
                                <h3 class="text-xl leading-6 font-bold text-gray-900">Monte sua catraca!</h3>
                            </div>
                        </div>
                        ...
                        <div class="flex flex-row justify-between">
                            <div class="bg-red-300 flex mt-6 justify-end items-center">
                                <ion-icon name="close-outline" size="large" id="closeModal" class=""></ion-icon>
                            </div>

                            <div class="mt-6 items-center">
                                <button class="border rounded-lg bg-red-500 hover:bg-red-600 font-semibold text-sm text-white py-1 px-1">Aplicar</button>
                            </div>
                        </div>
                    </div>
                </div>
